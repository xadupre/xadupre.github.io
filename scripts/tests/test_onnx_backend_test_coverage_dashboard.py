"""Tests for the onnx backend test coverage dashboard page."""
...
PAGE = os.path.join(
    REPO_ROOT, "dashboard", "onnx", "backend-test-coverage.html"
)


class TestOnnxBackendTestCoverageDashboard(unittest.TestCase):
