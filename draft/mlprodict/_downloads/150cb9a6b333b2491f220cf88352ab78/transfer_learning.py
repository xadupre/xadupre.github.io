...
# 
# The notebooks retrieve the already converted onnx model for [SqueezeNet](https://github.com/onnx/models/tree/master/vision/classification/squeezenet) and uses it in a pipeline created with [scikit-learn](https://scikit-learn.org/stable/).
...
# ## Transfer Learning
# 
# The class [OnnxTransformer](http://www.xavierdupre.fr/app/mlprodict/helpsphinx/mlprodict/sklapi/onnx_transformer.html?highlight=onnxtransformer#mlprodict.sklapi.onnx_transformer.OnnxTransformer) wraps a runtime into a class which follows scikit-learn API.
