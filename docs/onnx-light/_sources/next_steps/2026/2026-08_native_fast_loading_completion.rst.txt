...
Extend the prepared-object cache defined by
:ref:`l-next-steps-prepared-execution`. Resolve source digest, CPU/ISA, runtime,
kernel layout, and format compatibility from metadata.
