...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
    ...
    :download:`Download all examples in Python source code: auto_examples_python.zip </C:/xadupre/microsoft/onnxruntime/docs/python/auto_examples/auto_examples_python.zip>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

    :download:`Download all examples in Jupyter notebooks: auto_examples_jupyter.zip </C:/xadupre/microsoft/onnxruntime/docs/python/auto_examples/auto_examples_jupyter.zip>`
